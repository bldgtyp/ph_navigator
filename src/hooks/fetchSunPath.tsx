...
import { LadyBugSunPath } from "../types/LadybugSunPath";


export async function fetchSunPath(endpoint: string): Promise<LadyBugSunPath> {
    ...
    const lbtSunPathObject: LadyBugSunPath = JSON.parse(responseJson['message']);
